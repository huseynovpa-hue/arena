  ...
  return (
    <>
      ...
      <div style={{
        ...
        background: "#151d32", borderRadius: "16px", border: "1px solid #1c2a48",
        ...
        <div style={{
          ...
          background: "#080c16", border: "1px solid #1c2a48", borderRadius: "10px", padding: "10px 12px",
        }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
          ...
          <div style={{ display: "flex", gap: "8px" }}>
            <button onClick={shareWhatsApp}
              style={{
                flex: 1, padding: "10px", borderRadius: "10px", border: "1px solid #1c2a48",
                background: "#0f1525", color: "#e4e9f2", fontSize: "13px", fontWeight: 600, cursor: "pointer",
