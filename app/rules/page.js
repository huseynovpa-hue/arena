      ...
      <div className="card overflow-hidden">
        ...
        <div className="p-4">
          ...
          <div className="text-center text-[11px] text-[--muted] border-t border-[--border] pt-3">
            ...
            Winners receive their prizes within 5 days of the next month.<br/>
            <span className="text-amber-400 font-semibold">Prizes activate when we reach 100 registered users.</span>
          </div>
        </div>
      </div>
