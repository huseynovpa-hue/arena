...
const translations = {
  ...
  az: {
    ...
    privacyChanges: "Məxfilik Siyasətini vaxtaşırı yeniləyə bilərik. Hər hansı dəyişiklik barədə yeni siyasəti bu səhifədə yerləşdirməklə və \"Son yenilənmə\" tarixini yeniləməklə sizi xəbərdar edəcəyik. Bu səhifəni vaxtaşırı nəzərdən keçirməyiniz tövsiyə olunur.",
    privacyContactTitle: "11. Bizimlə Əlaqə",
    privacyContact: "Məxfilik Siyasəti ilə bağlı suallarınız varsa, bizimlə əlaqə saxlayın:",
  },
};
